"""
Django settings for ActualWebsite project.
...
ROOT_URLCONF = 'ActualWebsite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # only used for user authentication templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ActualWebsite.wsgi.application'
